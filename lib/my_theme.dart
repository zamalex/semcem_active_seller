...
class MyTheme {
  static const Color app_accent_color = const Color.fromRGBO(27,84,188,1);
  static Color app_accent_color_extra_light =
      Color.fromRGBO(233, 233, 240, 1.0);

  static Color splash_screen_color  =Color.fromRGBO(27,84,188,1); // if not sure , use the same color as accent color
  static Color login_reg_screen_color = Color.fromRGBO(27,84,188,1); // if not sure , use the same color as accent color
